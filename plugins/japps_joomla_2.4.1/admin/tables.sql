CREATE TABLE IF NOT EXISTS `#__layout_trans` (
 ...
 UNIQUE KEY `UK_dataset_tables_dbid_name` (`dbid`,`name`),
 ...
 PRIMARY KEY (`filid`),
 KEY `IX_file_node_path_type_name` (`path`,`type`,`name`)
) ENGINE=InnoDB /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci*/;
 ...
 KEY `IX_tour_node_rolid_isadmin_publish` (`rolid`,`isadmin`,`publish`)
) ENGINE=InnoDB /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci*/;
 ...
 `fromlgid` tinyint(255) unsigned DEFAULT '2',

...
echo "We were unable to load Joobi library for the component jApps. If you removed the joobi folder, please also remove this component from the Joomla component manager..";

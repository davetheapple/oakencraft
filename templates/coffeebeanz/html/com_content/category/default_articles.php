				...
				<?php endif; ?>
					<td <?php echo $headerTitle; ?> class="list-title">
						<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
							...
							//$a_imgs = $article->get("images"); // Get image parameters
							echo "<img class='prod-list-img' src='../" . $article->params->get("j2store")["thumb_image"] . "' />";
							echo "<div class='prod-intro-text'>" . $article->introtext . "</div>";
							//print_r($article);
							...
							<script>
								jQuery(document).ready(function() {
									jQuery("#jcart-<?php echo $article->params->get("j2store")["j2store_product_id"]; ?>")
										.append(jQuery(".j2store-product-<?php echo $article->params->get("j2store")["j2store_product_id"]; ?>"));
								});
							</script>
						<?php else: ?>
							<?php
					...
					<?php if ($this->params->get('list_show_author', 1)) : ?>
						<td <?php echo $headerAuthor; ?> class="list-author">
							<?php /*if (!empty($article->author) || !empty($article->created_by_alias)) : ?>
								...
								<?php endif; ?>
							<?php endif;*/ ?>
							<h3><?php echo number_format($article->params->get("j2store")["price"], 2); ?></h3>
						</td>
					<?php endif; ?>
					<?php if ($this->params->get('list_show_hits', 1)) : ?>
						<td <?php echo $headerHits; ?> class="list-hits">
							...
							<div id="jcart-<?php echo $article->params->get("j2store")["j2store_product_id"]; ?>"></div>
						</td>
					<?php endif; ?>
					<?php if ($isEditable) : ?>
